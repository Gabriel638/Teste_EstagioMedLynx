...
<body>
    <div class="container">
        <!-- Contêiner para envolver #nav-bar e .main-content -->
        <div class="content-wrapper">
            ...
            <div id="nav-bar">
                ...
                <div id="nav-content">
                    ...
                    <!--<div class="nav-button"><a href="/itensmaisconsumidos"><i class="fas fa-users"></i><span>Mais Consumidos</span></a></div>-->
    ...
    <h1>Bem-vindo DR. Magnovaldo !</h1>
    <p>Selecione na barra lateral o que deseja.</p>
</div>
</body>
</html>
